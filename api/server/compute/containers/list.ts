...
export const Input = z.object({
  output: z.enum(['wide', 'name', 'json', 'yaml', 'raw']).default('raw').optional(),
  name: ContainerName.optional(), // Filter by specific container name
  cluster: ClusterName.optional(), // Select specific cluster
