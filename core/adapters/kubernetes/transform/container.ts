...
import type { Container, ContainerInstance, ContainerPort, ContainerReplicas, ContainerStatus, ContainerSummary } from 'core/entities/compute/container.ts'
...
export function deploymentToContainer(
  ...
  const clusters = extractClusters(labels)
