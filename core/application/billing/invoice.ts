import { KubeClient } from 'core/adapters/kubernetes/kube-client.ts'
import { QontoClient } from 'core/adapters/qonto/mod.ts'
import { match } from 'ts-pattern'
import { CreateClientRequest } from 'core/adapters/qonto/client.ts'
