...
export class QontoApi {
  ...
  showExternalTransfer(
    pathParams: ShowExternalTransferPathParams,
    queryParams?: Record<string, any>,
  ): Promise<ShowExternalTransferResponse> {
  ...
  createExternalTransferWithTrustedBeneficiary(
    data: CreateExternalTransferWithTrustedBeneficiaryRequest,
    queryParams?: Record<string, any>,
  ): Promise<CreateExternalTransferWithTrustedBeneficiaryResponse> {
    const path = '/v2/external_transfers'
    return this.request<CreateExternalTransferWithTrustedBeneficiaryResponse>('post', path, data, queryParams)
  }

  createExternalTransfersWithBeneficiaryDataWithoutScaHeader(
    data: CreateExternalTransfersWithBeneficiaryDataWithoutScaHeaderRequest,
    queryParams?: Record<string, any>,
  ): Promise<CreateExternalTransfersWithBeneficiaryDataWithoutScaHeaderResponse> {
    const path = '/v2/external_transfers/checkout'
    return this.request<CreateExternalTransfersWithBeneficiaryDataWithoutScaHeaderResponse>(
      'post',
      path,
      data,
      queryParams,
  ...
  createExternalTransfersWithBeneficiaryDataWithScaHeader(
    data: CreateExternalTransfersWithBeneficiaryDataWithScaHeaderRequest,
    queryParams?: Record<string, any>,
  ): Promise<CreateExternalTransfersWithBeneficiaryDataWithScaHeaderResponse> {
    const path = '/v2/external_transfers/checkout'
    return this.request<CreateExternalTransfersWithBeneficiaryDataWithScaHeaderResponse>(
      'post',
      path,
      data,
      queryParams,
  ...
  showBeneficiary(
    pathParams: ShowBeneficiaryPathParams,
    queryParams?: Record<string, any>,
  ): Promise<ShowBeneficiaryResponse> {
  ...
  untrustListOfBeneficiaries(
    data: UntrustListOfBeneficiariesRequest,
    queryParams?: Record<string, any>,
  ): Promise<UntrustListOfBeneficiariesResponse> {
  ...
  showAttachment(
    pathParams: ShowAttachmentPathParams,
    queryParams?: Record<string, any>,
  ): Promise<ShowAttachmentResponse> {
  ...
  createAndInviteNewMembership(
    data: CreateAndInviteNewMembershipRequest,
    queryParams?: Record<string, any>,
  ): Promise<CreateAndInviteNewMembershipResponse> {
  ...
  getOrganizationAndItsBankAccounts(
    queryParams?: Record<string, any>,
  ): Promise<GetOrganizationAndItsBankAccountsResponse> {
  ...
  uploadAttachmentToTransaction(
    pathParams: UploadAttachmentToTransactionPathParams,
    queryParams?: Record<string, any>,
  ): Promise<UploadAttachmentToTransactionResponse> {
  ...
  listAttachmentsInTransaction(
    pathParams: ListAttachmentsInTransactionPathParams,
    queryParams?: Record<string, any>,
  ): Promise<ListAttachmentsInTransactionResponse> {
    const path = '/v2/transactions/:id/attachments'.replace(':id', pathParams.id)
    return this.request<ListAttachmentsInTransactionResponse>('get', path, undefined, queryParams)
  }

  removeAllAttachmentsFromTransaction(
    pathParams: RemoveAllAttachmentsFromTransactionPathParams,
    queryParams?: Record<string, any>,
  ): Promise<RemoveAllAttachmentsFromTransactionResponse> {
    const path = '/v2/transactions/:id/attachments'.replace(':id', pathParams.id)
  ...
  removeAttachmentFromTransaction(
    pathParams: RemoveAttachmentFromTransactionPathParams,
    queryParams?: Record<string, any>,
  ): Promise<RemoveAttachmentFromTransactionResponse> {
  ...
  showTransaction(
    pathParams: ShowTransactionPathParams,
    queryParams?: Record<string, any>,
  ): Promise<ShowTransactionResponse> {
  ...
  createMultiTransferRequest(
    data: CreateMultiTransferRequestRequest,
    queryParams?: Record<string, any>,
  ): Promise<CreateMultiTransferRequestResponse> {
    const path = '/v2/requests/multi_transfers'
    return this.request<CreateMultiTransferRequestResponse>('post', path, data, queryParams)
  }

  approveRequest(
    pathParams: ApproveRequestPathParams,
    data: ApproveRequestRequest,
    queryParams?: Record<string, any>,
  ): Promise<ApproveRequestResponse> {
    const path = '/v2/requests/:request_type/:id/approve'.replace(':request_type', pathParams.request_type).replace(
      ':id',
      pathParams.id,
    )
  ...
  declineRequest(
    pathParams: DeclineRequestPathParams,
    data: DeclineRequestRequest,
    queryParams?: Record<string, any>,
  ): Promise<DeclineRequestResponse> {
    const path = '/v2/requests/:request_type/:id/decline'.replace(':request_type', pathParams.request_type).replace(
      ':id',
      pathParams.id,
    )
  ...
  getListOfSupplierInvoicesForOrganization(
    queryParams?: Record<string, any>,
  ): Promise<GetListOfSupplierInvoicesForOrganizationResponse> {
  ...
  createSupplierInvoicesWithAttachments(
    queryParams?: Record<string, any>,
  ): Promise<CreateSupplierInvoicesWithAttachmentsResponse> {
  ...
  getListOfClientInvoicesForOrganization(
    queryParams?: Record<string, any>,
  ): Promise<GetListOfClientInvoicesForOrganizationResponse> {
  ...
  createClientInvoice(
    ...
    queryParams?: Record<string, any>,
  ): Promise<CreateClientInvoiceResponse> {
    const path = '/v2/client_invoices'
    return this.request<CreateClientInvoiceResponse>('post', path, data, queryParams)
  }

  showClientInvoice(
    pathParams: ShowClientInvoicePathParams,
    queryParams?: Record<string, any>,
  ): Promise<ShowClientInvoiceResponse> {
  ...
  getListOfCreditNotesForOrganization(
    queryParams?: Record<string, any>,
  ): Promise<GetListOfCreditNotesForOrganizationResponse> {
    const path = '/v2/credit_notes'
    return this.request<GetListOfCreditNotesForOrganizationResponse>('get', path, undefined, queryParams)
  }

  getDetailsOfCreditNoteForOrganization(
    pathParams: GetDetailsOfCreditNoteForOrganizationPathParams,
    queryParams?: Record<string, any>,
  ): Promise<GetDetailsOfCreditNoteForOrganizationResponse> {
  ...
  getClientSDetails(
    pathParams: GetClientSDetailsPathParams,
    queryParams?: Record<string, any>,
  ): Promise<GetClientSDetailsResponse> {
  ...
  showStatement(
    pathParams: ShowStatementPathParams,
    queryParams?: Record<string, any>,
  ): Promise<ShowStatementResponse> {
